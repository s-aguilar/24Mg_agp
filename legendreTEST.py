...
for ch in channels:
    ...
    totalCross2 = integrate.romberg(spline1,min(energyList),max(energyList),divmax=20)
    ...
    for T in temperature:
        ...
        # intg = integrate.quad(integrand1,min(energyList),max(energyList),limit=100)
        ...
        rate =  1.1359E12* mu**(-.5) * T**(-1.5) * intg
        rxnRate.append(rate)
